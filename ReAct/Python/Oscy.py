...
reactions = (
    ...
    (1, 'mRNA_n'), (1, 'mRNA_c'), 10,

    # (1, 'mRNA_c'), (1, 'mRNA_n'), 5,

    (1, 'Prot2_c'), (1, 'Prot2_n'), 0.1,

    (1, 'Prot2_n'), (1, 'Prot2_c'), 1,

    (1, 'Prot2_n', 1, 'DNA'), (1, 'DNAP2'), 1,

    (1, 'DNAP2'), (1, 'Prot2_n', 1, 'DNA'), 0.1,

    (1,'Prot',1,'Enz'),(1,'ProtEnz'), 100,

    (1,'ProtEnz'),(1,'Prot',1,'Enz'), 10,
